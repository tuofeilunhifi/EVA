...
# def zero_shot_retrieval_eval(model, dataloader, tokenizer, device, amp=True, recall_k_list=[5]):
def zero_shot_retrieval_eval(model, data, epoch, args):
    """
    ...
    dataloader = data['flickr30k'].dataloader
    ...
    # scores = (100.0 * texts_emb @ images_emb.T).softmax(dim=-1)
