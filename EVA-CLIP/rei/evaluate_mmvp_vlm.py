...
def benchmark_model(model_name, benchmark_dir, device = "cpu"):
    ...
    # model_name="EVA02-CLIP-B-16-InternVL-LLaMA-CN-7B"
    pretrained=''
    precision='amp'
    device='cuda:0'
    torchscript=False
    ...
    # pretrained_image="/mnt/pfs-guan-ssai/cv/cjy/models/mindvit/2024_04_17/eva_clip_b_224_e40.bin"
    # pretrained_image="/mnt/pfs-guan-ssai/cv/cjy/models/mindvit/2024_04_23/eva_clip_l_336_e10.bin"
    pretrained_image="/mnt/pfs-guan-ssai/cv/cjy/models/mindvit/2024_05_08/eva_clip_l_336_e8.bin"
