...
source_recipe_dir = '/mnt/pfs-guan-ssai/cv/cjy/data/laion2B-en/recipe_1200m'
target_tar_dir = '/mnt/pfs-mc0p4k/cv/team/cjy/datasets/wds/laion2b-en/recipe_1200m'
...
json_num = 128
# json_num = 332
process_args = [i for i in range(64, json_num)]
