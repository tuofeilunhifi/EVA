...
MODEL=EVA02-CLIP-L-14-LLaMA2-Tokenizer
...
torchrun --nnodes=${WORLD_SIZE} \
  ...
  --rdzv_endpoint=${MASTER_IP}:${MASTER_PORT} \
    training/main.py \
        ...
        --skip-list head.weight head.bias lm_head.weight lm_head.bias mask_token text_projection logit_scale token_embedding.weight\
        --seed 4096 \
        --gather-with-grad \
        --grad-checkpointing \
        --local-loss \
