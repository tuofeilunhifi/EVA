...
MERGE_500M_DATA_PATH="/mnt/pfs-mc0p4k/cv/team/cjy/datasets/wds/laion2b-en/recipe_1200m/{00000..00127}.tar;/mnt/pfs-mc0p4k/cv/team/cjy/datasets/wds/wukong/wukong-100m-part-{0..15}.tar"
...
torchrun --nnodes=${WORLD_SIZE} \
  ...
  --rdzv_endpoint=${MASTER_IP}:${MASTER_PORT} \
    training/main.py \
        ...
        --train-num-samples-list 40000000 3000000\
        --dataset-resampled \
