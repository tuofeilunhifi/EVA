...
# MERGE_500M_DATA_PATH="/mnt/spaceai-internal/ark/ark/cv/mc0p4k/panxuhao/data/laion2b-wds-vit;/mnt/pfs-mc0p4k/cv/team/panxuhao/wds_utils/wukong/tarfiles;/mnt/pfs-mc0p4k/cv/team/panxuhao/wds_utils/cc3m/tarfiles;/mnt/pfs-mc0p4k/cv/team/panxuhao/wds_utils/cc12m/tarfiles"
...
torchrun --nnodes=${WORLD_SIZE} \
  ...
  --rdzv_endpoint=${MASTER_IP}:${MASTER_PORT} \
    training/main.py \
        ...
        --skip-list head.weight head.bias lm_head.weight lm_head.bias mask_token logit_scale visual.proj \
        --seed 4096 \
        --gather-with-grad \
        --grad-checkpointing \
        --local-loss \
